---
title: BrainAPI Retrieve API
description: Search and retrieve passages, graph data, observations, and recommendations.
full: true
_openapi:
  preload:
  ...
  structuredData:
    ...
    contents:
      ...
      - content: Post Recommend. See the BrainAPI developer documentation for request,
          response, authentication, and retry semantics.
        heading: post-recommend
      - content: >-
      ...
      - content: Get Search. See the BrainAPI developer documentation for request,
          response, authentication, and retry semantics.
        heading: get-search
      - content: Post Search. See the BrainAPI developer documentation for request,
          response, authentication, and retry semantics.
        heading: post-search
      ...
      - content: Get text chunks by a query text and optional metadata equality filters.
