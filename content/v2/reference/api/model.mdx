---
title: BrainAPI Model API
description: Create and update typed entities and relationships.
full: true
_openapi:
  preload:
...
export default function Layout(props) {
  ...
  return (
    <>
      {props.children}
      <Comp document="schemas/brainapi-v2.openapi.json" webhooks={[]} operations={[{"path":"/model/entity","method":"post"},{"path":"/model/entity","method":"put"},{"path":"/model/relationship","method":"post"},{"path":"/model/relationship","method":"put"}]} showTitle showDescription />
    </>
  );
}