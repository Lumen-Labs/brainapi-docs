...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <>
        <ThemeLogo />
        <span className="font-[var(--font-outfit)] font-bold text-2xl">
          BrainAPI
        </span>
      </>
    ),
...
export const docsSidebarBanner = (
  <div className="flex flex-col gap-2 my-3">
    <GitHubStarBanner />
    <a
      className="py-3 px-4 border-[1.5px] flex items-center gap-2 hover:-translate-y-[1px] transition-all duration-300"
      href="https://discord.gg/VTngQTaeDf"
      target="_blank"
